...
//            BancaSellaForm.openAlert(message);
        ...
        saveDataCC: function (form){
            ...
            BancaSellaForm.ccData.cc = form.down("[name='bancasella_iframe[cc_number]']", 0).value;
            BancaSellaForm.ccData.expmm = form.down("[name='bancasella_iframe[cc_exp_mm]']", 0).value;
            BancaSellaForm.ccData.expyy = form.down("[name='bancasella_iframe[cc_exp_yy]']", 0).value;
            BancaSellaForm.ccData.cvv2 = form.down("[name='bancasella_iframe[cc_cvv]']", 0).value;
            BancaSellaForm.ccData.name = form.down("[name='bancasella_iframe[cc_name]']", 0).value;
            BancaSellaForm.ccData.email = form.down("[name='bancasella_iframe[cc_email]']", 0).value;
